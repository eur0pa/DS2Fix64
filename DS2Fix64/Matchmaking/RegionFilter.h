...
extern void __fastcall tCreateLobby(void*, void*, ELobbyType, int);
extern void __fastcall tJoinLobby(void*, void*, CSteamID);
extern void __fastcall tLeaveLobby(void*, void*, CSteamID);
